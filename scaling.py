...
class Scaling(object):
    ...
    def __init__(self, variance=None, covariance=None, compute_inverse=False):
        ...
        :param variance: float, optional (default: None)
                         A scalar scaling factor or the statistical variance of a variable.
        :param covariance: array-like, shape = (n_params,) or (n_params, n_params),
    ...
    def _combine(self):
        """
        Combine variance and covariance into a single scaling variable.
        :return:
        """
        self.scaling_ = 1.0
